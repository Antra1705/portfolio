            ...
            >
                ...
                <div className="bg-white/10 px-4 py-2.5 flex items-center justify-between border-b border-white/10">
                    <div className="flex items-center gap-4 flex-1">
                        <div className="flex gap-2 items-center">
                            <button onClick={onClose} className="w-3.5 h-3.5 rounded-full bg-[#FF5F56] flex items-center justify-center group cursor-pointer">
                                <IoClose className="text-[10px] text-black/40 opacity-0 group-hover:opacity-100" />
                            </button>
                            <div className="w-3.5 h-3.5 rounded-full bg-[#FFBD2E] cursor-pointer"></div>
                            <div className="w-3.5 h-3.5 rounded-full bg-[#27C93F] cursor-pointer"></div>
                        </div>
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex items-center bg-white/10 rounded-md px-1 py-1">
                            <button className="px-2 py-0.5 text-white/60 hover:text-white cursor-pointer"><IoSearch className="text-sm scale-x-[-1]" /></button>
                            <div className="w-px h-3 bg-white/10"></div>
                            <button className="px-2 py-0.5 text-white/60 hover:text-white cursor-pointer"><span className="text-[10px] font-bold">1:1</span></button>
                            <div className="w-px h-3 bg-white/10"></div>
                            <button className="px-2 py-0.5 text-white/60 hover:text-white cursor-pointer"><IoSearch className="text-sm" /></button>
                        </div>
                        <button className="p-1.5 bg-[#3b82f6] rounded-md text-white shadow-inner cursor-pointer"><IoCreateOutline className="text-base" /></button>
                        <button className="p-1.5 hover:bg-white/10 rounded-md text-white/60 cursor-pointer"><IoScanOutline className="text-base" /></button>
                        <div className="w-px h-6 bg-white/10 mx-1"></div>
                        <button className="p-1.5 hover:bg-white/10 rounded-md text-white/60 cursor-pointer"><IoChevronForward className="text-lg" /></button>
                        <button className="p-1.5 hover:bg-white/10 rounded-md text-white/60 cursor-pointer"><IoSearch className="text-lg" /></button>
                    </div>
                </div>
                ...
                <div className="bg-white/5 px-6 py-1.5 flex items-center gap-5 border-b border-white/10">
                    <div className="flex items-center gap-3 text-white/40">
                        <IoScanOutline className="text-base hover:text-white transition-colors cursor-pointer" />
                        <IoSearch className="text-base hover:text-white transition-colors cursor-pointer" />
                    </div>
                    <div className="w-px h-4 bg-white/10"></div>
                    <div className="flex items-center gap-4 text-white/40">
                        <IoCreateOutline className="text-base hover:text-white transition-colors cursor-pointer" />
                        <IoScanOutline className="text-base hover:text-white transition-colors rotate-45 cursor-pointer" />
                        <IoGridOutline className="text-base hover:text-white transition-colors cursor-pointer" />
                        <div className="flex items-center gap-1 bg-white/10 rounded px-1 py-0.5 cursor-pointer">
                        ...
                        <IoTextOutline className="text-base hover:text-white transition-colors cursor-pointer" />
                        <IoPersonOutline className="text-base hover:text-white transition-colors cursor-pointer" />
                    </div>
                    <div className="w-px h-4 bg-white/10"></div>
                    <div className="flex items-center gap-4 text-white/40">
                    ...
                    <div className="bg-white/5 px-6 py-4 flex items-center border-b border-white/10">
                        ...
                        <div className="flex items-center gap-6 text-white/60 ml-auto">
                            <div className="flex bg-white/10 rounded-md p-1 border border-white/10">
                                <div className="p-1 bg-white/10 rounded cursor-pointer hover:bg-white/20 transition-colors"><IoGridOutline className="text-sm" /></div>
                                <div className="p-1 cursor-pointer hover:bg-white/10 rounded transition-colors"><IoListOutline className="text-sm" /></div>
                            </div>
                            <IoSearch className="text-xl cursor-pointer hover:text-white transition-colors" />
                        </div>
                    </div>
                                ...
                                {!selectedFolder ? (
                                    ...
                                    >
                                        ...
                                        <button 
                                            ...
                                            className="flex items-center gap-2 text-[#60a5fa] hover:underline mb-12 font-bold text-sm tracking-tight cursor-pointer"
                                        >
                                            <IoChevronBack />
                                            Projects
                                        </button>
            ...
            <AnimatePresence>
                {activeProject && (
                    ...
                    >
                        ...
                        <div className="py-1">
                            {activeProject.link && (
                                <button 
                                    ...
                                    className="w-full px-3 py-1.5 flex items-center justify-between text-xs text-white/90 hover:bg-[#3b82f6] hover:text-white group transition-colors cursor-pointer"
                                >
                        ...
                        {/* Secondary Actions */}
                        <div className="py-1">
                            <div className="px-3 py-1.5 flex items-center gap-2 text-xs text-white/40 cursor-pointer hover:bg-white/5 transition-colors">
                        ...
                        <div className="px-3 py-2 flex items-center justify-between">
                            <div className="flex gap-2">
                                <div className="w-3 h-3 rounded-full bg-[#FF5F56] border border-white/20 cursor-pointer"></div>
                                <div className="w-3 h-3 rounded-full bg-[#FFBD2E] border border-white/20 cursor-pointer"></div>
                                <div className="w-3 h-3 rounded-full bg-[#27C93F] border border-white/20 cursor-pointer"></div>
                                <div className="w-3 h-3 rounded-full bg-[#3b82f6] border border-white/20 cursor-pointer"></div>
                            </div>
                            <span className="text-[10px] text-white/30 font-bold cursor-pointer">Tags...</span>
                        </div>
                    </motion.div>
                )}
            </AnimatePresence>
